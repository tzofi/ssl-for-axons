...
opt['batch_size']           = 6
opt['weights_path']         = 'weights/transfer_unet'
opt['validate']             = True
opt['parallel']             = True
...
for REP in range(REPS):
    ...
    model.load_state_dict(load_my_state_dict(model, pretrained_encoder))
    print("Encoder weights from auxillary task loaded.")
